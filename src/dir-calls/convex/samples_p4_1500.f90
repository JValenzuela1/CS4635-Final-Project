...
! Output file.
CHARACTER(LEN=20), PARAMETER :: OUTFILE = "samples_out_p4_1500.txt"
...
CALL VTMOP_SOLVE( D, P, LB, UB, OBJ_F, PARETO_X, PARETO_F, IERR,   &
                  ADAPTIVE_SEARCH=.TRUE., BB_BUDGET=1500,          &
                  MAXITERS=1500, SEARCH_BUDGET=D,                  &
...
CALL VTMOP_SOLVE( D, P, LB, UB, OBJ_F, PARETO_X, PARETO_F, IERR,   &
                  ADAPTIVE_SEARCH=.TRUE., BB_BUDGET=3000,          &
                  MAXITERS=3000, SEARCH_BUDGET=D,                  &
                  INITIAL_SBUDGET=2*D, LOPT_BUDGET=2500,           &
                  DECAY=0.5_R8, DES_TOL=SQRT(MU), EPS=SQRT(MU),    &
                  EPSW=MU**0.25_R8, OBJ_TOL=SQRT(MU),              &
                  MIN_RADF=0.02_R8, TRUST_RADF=0.2_R8,             &
